...
if __name__ == '__main__':
    ...
    parser.add_argument('--model2', type=str, default='GCN', choices=["MLP","GCN","GAT","GIN"
                         "Sage","gcn-spmoe","sage-spmoe","GPR-GNN", "adagcn"], 
    ...
    if args.setting == 'exp' or args.setting == 'hetero_exp':
        ...
        if args.method == 'mowst_star' or args.method == 'mowst':
            ...
            elif args.model2 == "adagcn":
                lrs = [.01, .005, .001]
                ada_layers = [5, 10]
                dps = [0.0, 0.5]
                for lr in lrs:
                    for ada_layer in ada_layers:
                        for dp in dps:
                            args.adagcn_layers = ada_layer
                            args.lr = lr
                            args.dropout = dp
